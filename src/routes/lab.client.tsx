        ...
        <AnimatePresence mode="wait">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        disabled={!!file}
                        className="w-full h-44 bg-black/40 border border-border rounded-xl p-4 text-xs font-mono outline-none focus:border-cyan-500 resize-none placeholder:text-muted-foreground disabled:opacity-50"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="glass rounded-3xl p-6 flex flex-col justify-between">
                  <div>
                    ...
                    <div
                      ...
                      className={`cursor-pointer rounded-2xl border-2 border-dashed p-10 text-center transition-all min-h-[190px] flex flex-col justify-center ${dragOver ? "border-cyan-500 bg-cyan-500/5 scale-[1.01]" : "border-border bg-white/5 hover:border-cyan-500/60"}`}
                    >
          ...
          {state === "compiling" && (
            ...
            >
              ...
              {/* Console logs card */}
              <div className="bg-black/80 border border-white/10 rounded-2xl p-6 font-mono text-xs text-success-foreground min-h-[260px] flex flex-col justify-start space-y-1.5 shadow-2xl overflow-y-auto">
                <div className="text-white/40 pb-2 border-b border-white/5 flex justify-between items-center">
                ...
                <div className="flex items-center gap-4">
                  <div className="relative grid h-24 w-24 place-items-center">
                    ...
                    <div className="absolute flex flex-col items-center">
                      ...
                      <div className="text-[8px] font-bold text-white/40">/100</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="glass rounded-3xl p-6 border border-white/5 space-y-4 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-xs text-white/80 leading-relaxed bg-white/5 border border-white/5 rounded-xl p-4">
                      {result.feedback}
                    </p>
                  </div>
                ...
                <div className="glass rounded-3xl p-6 border border-white/5">
                  ...
                  <ul className="text-xs space-y-2 text-white/80">
                    {result.strengths && result.strengths.map((str: string, i: number) => (
                      <li key={i} className="flex gap-2 items-start bg-white/5 rounded-xl px-4 py-2 border border-white/5">
                        <Check className="h-3.5 w-3.5 text-success shrink-0 mt-0.5" />
                        <span>{str}</span>
                      </li>
                    ))}
                ...
                <div className="space-y-4">
                  {result.timeline && result.timeline.map((item: any, i: number) => (
                    <div key={i} className="flex gap-4 items-start">
                      ...
                      <div className="flex-1 bg-white/5 border border-white/5 rounded-xl p-3.5">
